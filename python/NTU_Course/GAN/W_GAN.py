...
if __name__ == "__main__":
    ...
    def getData(folder, quantity):
        ...
        return TensorDataset(torch.tensor(data, dtype=torch.float64), torch.tensor(target, dtype=torch.float64))

    dataloader = torch.utils.data.DataLoader(
        getData("./data/archive/faces/", 80000),
        batch_size=opt.batch_size,
        shuffle=True,
    )
