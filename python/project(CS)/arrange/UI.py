...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.outside.setGeometry(QtCore.QRect(570, 200, 81, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(18)
        ...
        self.health.setGeometry(QtCore.QRect(520, 280, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(18)
        ...
        self.outside_text.setGeometry(QtCore.QRect(653, 200, 51, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(18)
        ...
        self.result_text.setGeometry(QtCore.QRect(654, 340, 51, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(18)
        ...
        self.inside_text.setGeometry(QtCore.QRect(653, 150, 51, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(18)
        ...
        self.Sobelfilter.setGeometry(QtCore.QRect(323, 350, 141, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight SemiConde")
        font.setPointSize(14)
        ...
        self.Cannyedge.setGeometry(QtCore.QRect(323, 390, 151, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight SemiConde")
        font.setPointSize(14)
        ...
        self.Center.setGeometry(QtCore.QRect(80, 310, 201, 41))
        font = QtGui.QFont()
        ...
        self.checkBox_3.setGeometry(QtCore.QRect(80, 396, 121, 19))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(14)
    ...
    def Analysis(self, name, length):
        ...
        inRadius, outRadius = Total_Radius(name, length, filter_mode, False)
        self.inside_text.setText(str(round(inRadius, 3)))
        self.outside_text.setText(str(round(outRadius, 3)))   
