...
class UI(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.path = ".//Dataset_OpenCvDl_Hw2//Q{}_Image//"
    ...
    def setup_camera_calibration(self):
        self.corner_detection_fcn = corner_detection_fcn = corner_detection(self.path.format(2))

    def setup_augmented_reality(self):
        self.augmented_reality_fcn = augmented_reality(self.path.format(3))

    def setup_stereo_disparity_map(self):
        self.stereo_disparity_map_fcn = stereo_disparity_map(self.path.format(4))
