...
target1 = Probability(file["BA"],0) 
plt.plot(range(len(target1)),target1,"o")

target2 = Probability(file["BA"],1) 
plt.plot(range(len(target2)),target2,"o")

target3 = Probability(file["BA"],2) 
plt.plot(range(len(target3)),target3,"o")

target4 = Probability(file["BA"],3) 
plt.plot(range(len(target4)),target4,"o")

plt.show()

#plt.savefig(graph)

#np.savez("./npzfile/"+npzname,phase1 = target1,phase2 = target2,phase3 = target3,phase4 = target4)
