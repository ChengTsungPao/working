...
flag = 1
while flag==1 :
    dim = input("input the dimension of network : ")    
    if dim == "2":        
        flag = 0
    elif dim == "4":        
        flag = 0
    else:
        print("input the correct dimension !!!\n")
...
if(dim=="2"):
    ...
    while flag==1 :
        N = input("N = ")
        if N == "5":
            internet = [(5, 16, (2,2,2), 1, (1,1,1)),(16, 32, (2,2,2), 1, (1,1,1)),(32 * 2 * 2 * 2, 128, 2)] #5x5
            flag = 0
        elif N == "6":
            internet = [(6, 16, (3,3,3), 1, (1,1,1)),(16, 32, (2,2,2), 1, (1,1,1)),(32 * 2 * 2 * 2, 128, 2)] #6x6
            flag = 0
        elif N == "7":
            internet = [(7, 16, (2,2,2), 1, (1,1,1)),(16, 32, (3,3,3), 1, (1,1,1)),(32 * 2 * 2 * 2, 128, 2)] #7x7
            flag = 0
        elif N == "8":
            internet = [(8, 16, (3,3,3), 1, (1,1,1)),(16, 32, (3,3,3), 1, (1,1,1)),(32 * 2 * 2 * 2, 128, 2)] #8x8
            flag = 0
        else:
            print("input the correct N !!!\n")
    ...
    print(cnn)
    summary(cnn,(int(N),int(N),int(N),int(N)),-1)
